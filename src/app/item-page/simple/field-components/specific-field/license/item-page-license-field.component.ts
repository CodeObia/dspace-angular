...
export class ItemPageLicenseFieldComponent extends ItemPageFieldComponent {
  ...
  parseLicense(license: string) {
    if (license.match(/CC[\s-]BY[\s-][1234]/i) != null) {
      return 'by.svg';
    } else if (license.match(/CC[\s-]BY[\s-]SA[\s-][1234]/) != null) {
      return 'by-sa.svg';
    } else if (license.match(/CC[\s-]BY[\s-]ND[\s-][1234]/) != null) {
      return 'by-nd.svg';
    } else if (license.match(/CC[\s-]BY[\s-]NC[\s-][1234]/) != null) {
      return 'by-nc.svg';
    } else if (license.match(/CC[\s-]BY[\s-]NC[\s-]SA[\s-][1234]/) != null) {
      return 'by-nc-sa.svg';
    } else if (license.match(/CC[\s-]BY[\s-]NC[\s-]ND[\s-][1234]/) != null) {
      return 'by-nc-nd.svg';
    } else if (license.match(/CC0[\s-]1.0/) != null) {
      return 'cc-zero.svg';
    } else {
